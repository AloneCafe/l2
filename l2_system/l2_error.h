...
typedef enum _l2_parsing_error_type {
    ...
    L2_PARSING_ERROR_MAY_LOSE_RIGHT_PAIR_OF_PARENTHESES,
    L2_PARSING_ERROR_INCOMPLETE_CONDITION_EXPRESSION,
    L2_PARSING_ERROR_MISSING_SEMICOLON,
    L2_PARSING_ERROR_MISSING_BLOCK_END_MARK,
    ...
    L2_PARSING_ERROR_CONDITION_MUST_BE_A_BOOL_VALUE,
    L2_PARSING_ERROR_LEFT_SIDE_OF_OPERATOR_MUST_BE_A_BOOL_VALUE,
    L2_PARSING_ERROR_RIGHT_SIDE_OF_OPERATOR_MUST_BE_A_BOOL_VALUE,
    L2_PARSING_LEFT_SIDE_OF_OPERATOR_MUST_BE_A_INTEGER_VALUE,
    L2_PARSING_RIGHT_SIDE_OF_OPERATOR_MUST_BE_A_INTEGER_VALUE,
    L2_PARSING_ERROR_DUALISTIC_OPERATOR_CONTAINS_IMCOMPATIBLE_TYPE,
    L2_PARSING_ERROR_UNITARY_OPERATOR_CONTAINS_IMCOMPATIBLE_TYPE
